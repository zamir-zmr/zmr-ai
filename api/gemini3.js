...
export default async function handler(req, res) {
  ...
  if (!apiKey) {
    res.status(500).json({ error: { message: 'Server misconfigured: GEMINI_API_KEY_3 (ya GEMINI_API_KEY) missing' } });
    return;
  }
  ...
  // Frontend isko header se padhkar chat me sahi model-naam (Gemini 3)
